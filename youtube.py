...
@cokepokesmusic_bot.on_message(filters.private
                   & filters.text
                   & ~filters.edited
...
@cokepokesmusic_bot.on_callback_query(filters.regex("^ytdl_audio$"))
async def callback_query_ytdl_audio(_, callback_query):
    try:
        ...
        with YoutubeDL(ydl_opts) as ydl:
            ...
            # download
            await callback_query.edit_message_text("**Mahnı Yüklənir ...**")
